...
class ApiModule {
    ...
    @Provides
    @Singleton
    fun provideAlbumsApiImplementation(retrofit: Retrofit): TopAlbumsApiInterface {
        return retrofit.create(TopAlbumsApiInterface::class.java)
    }


    @Provides
    @Singleton
    fun provideGeoApiImplementation(retrofit: Retrofit): GeoArtistApiInterface {
        return retrofit.create(GeoArtistApiInterface::class.java)
    }
}